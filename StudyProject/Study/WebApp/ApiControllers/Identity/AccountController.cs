...
public class AccountController : ControllerBase
{
        ...
        int expiresInSeconds)
    {
        ...
        if (appUser == null)
        {
            ...
            return BadRequest("User is not found after registration");
        }
    ...
    /// <summary>
    /// Log in with already existing account
    /// </summary>
    /// <param name="loginInfo">Username and password. And personal details.</param>
    /// <param name="expiresInSeconds">Override jwt lifetime for testing.</param>
    /// <returns>JWTResponse - jwt and refresh token</returns>
    [HttpPost]
    [Produces( "application/json" )]
    ...
    /// <param name="expiresInSeconds">Override jwt lifetime for testing.</param>
    /// <returns>New JWT and RefreshToken</returns>
    [HttpPost]
    [Produces( "application/json" )]
    [Consumes("application/json")]
    [ProducesResponseType<JWTResponse>((int) HttpStatusCode.OK)]
    ...
    )
    {
        ...
        {
            return NotFound("RefreshTokens collection is null or empty - {appUser.RefreshTokens?.Count}");
        }
